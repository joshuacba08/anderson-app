...
import avatar from '../assets/images/Josue_Oroya.jpg';
            ...
            <>
                ...
                <section className="info-slider info-slider--activo">
                    ...
                    <div className="data-container">
                        ...
                        <article className="info-slide__download">
                            <a href="https://drive.google.com/file/d/1DPwXIZHq8NlTYul42nM-6jaa8CTwTxX9/view?usp=sharing" target="_blank" rel="noreferrer">
                                <h4>DOWNLOAD CV <i className="icon background-image icon--download"></i></h4>
                            </a>
